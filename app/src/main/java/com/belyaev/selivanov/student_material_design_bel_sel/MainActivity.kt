...
import com.belyaev.selivanov.student_material_design_bel_sel.data.Student
...
import com.belyaev.selivanov.student_material_design_bel_sel.data.students
...
@Composable
fun StudentPreview() {
    Student_Material_Design_bel_selTheme(darkTheme = false) {
        StudentApp()
    }
}
...
fun StudentDarkThemePreview(){
    Student_Material_Design_bel_selTheme(darkTheme = true) {
        StudentApp()
    }
}
    ...
    IconButton(
        ...
        Icon(
            ...
            contentDescription = stringResource(R.string
                .expand_button_content_description),
